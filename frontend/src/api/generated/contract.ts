...
export const ActivitySseEvent = z.object({ actor_display_name: z.string(), actor_id: z.string(), created_at: z.string(), entity_id: z.string(), entity_type: z.string(), entity_version: z.number().int(), event_id: z.number().int(), event_type: EventType, payload: ActivitySsePayload }).catchall(z.unknown());
...
export const LayoutItem = z.object({ h: z.number().int(), i: z.string(), w: z.number().int(), x: z.number().int(), y: z.number().int() }).catchall(z.unknown());
...
export const ListWidgetResponse = z.object({ config: ListWidgetConfig, created_at: z.iso.datetime(), dashboard_id: z.uuid(), id: z.uuid(), resource_id: z.uuid().nullable(), resource_type: z.string().nullable(), updated_at: z.iso.datetime(), widget_type: z.literal("list"), widget_version: z.number().int() }).catchall(z.unknown());

export type DashboardResponse = z.infer<typeof DashboardResponse>;
export const DashboardResponse = z.object({ can_edit: z.boolean(), can_manage_shares: z.boolean(), id: z.uuid(), is_favorite: z.boolean(), is_shared: z.boolean(), layout: z.array(LayoutItem), name: z.string(), user_id: z.uuid(), version: z.number().int(), widgets: z.array(z.discriminatedUnion("widget_type", [AgendaWidgetResponse.extend({ widget_type: z.literal("agenda") }), CalendarWidgetResponse.extend({ widget_type: z.literal("calendar") }), ClockWidgetResponse.extend({ widget_type: z.literal("clock") }), ListWidgetResponse.extend({ widget_type: z.literal("list") })])) }).catchall(z.unknown());
...
export const HTTPValidationError = z.object({ detail: z.array(ValidationError) }).partial().catchall(z.unknown());

export type HealthResponse = z.infer<typeof HealthResponse>;
export const HealthResponse = z.object({ status: z.string() }).catchall(z.unknown());

export type InheritedDashboardAccessResponse = z.infer<typeof InheritedDashboardAccessResponse>;
export const InheritedDashboardAccessResponse = z.object({ dashboard_id: z.uuid(), dashboard_name: z.string() }).catchall(z.unknown());

export type InviteAcceptResponse = z.infer<typeof InviteAcceptResponse>;
export const InviteAcceptResponse = z.object({ dashboard_id: z.uuid(), dashboard_name: z.string(), role: EffectiveRole }).catchall(z.unknown());
...
export const InvitePreviewResponse = z.object({ dashboard_name: z.string(), invited_by: z.string(), role: ShareRole }).catchall(z.unknown());

export type InviteResponse = z.infer<typeof InviteResponse>;
export const InviteResponse = z.object({ created_at: z.iso.datetime(), expires_at: z.iso.datetime(), id: z.uuid(), role: ShareRole }).catchall(z.unknown());
...
export const ListCreate = z.object({ dashboard_id: z.uuid(), list_type: ListType, name: z.string().min(1).max(200) }).catchall(z.unknown());

export type ListItemResponse = z.infer<typeof ListItemResponse>;
export const ListItemResponse = z.object({ assigned_to: z.uuid().nullable(), category: z.string().nullable(), checked: z.boolean(), created_at: z.iso.datetime(), created_by: z.uuid(), due_date: z.iso.date().nullable(), id: z.uuid(), list_id: z.uuid(), priority: ItemPriority.nullable(), sort_order: z.number().int(), text: z.string(), updated_at: z.iso.datetime() }).catchall(z.unknown());

export type ListDetailResponse = z.infer<typeof ListDetailResponse>;
export const ListDetailResponse = z.object({ created_at: z.iso.datetime(), created_by: z.uuid(), dashboard_id: z.uuid(), id: z.uuid(), item_count: z.number().int(), items: z.array(ListItemResponse), list_type: ListType, name: z.string(), sort_order: z.number().int(), updated_at: z.iso.datetime() }).catchall(z.unknown());

export type ListItemCreate = z.infer<typeof ListItemCreate>;
export const ListItemCreate = z.object({ assigned_to: z.uuid().nullable().optional(), category: z.string().max(100).nullable().optional(), due_date: z.iso.date().nullable().optional(), priority: ItemPriority.nullable().optional(), text: z.string().min(1).max(2000) }).catchall(z.unknown());
...
export const NotificationResponse = z.object({ body: z.string(), created_at: z.iso.datetime(), id: z.uuid(), read_at: z.iso.datetime().nullable(), reference_id: z.uuid().nullable(), reference_type: z.string().nullable(), title: z.string(), type: z.string() }).catchall(z.unknown());

export type NotificationPageResponse = z.infer<typeof NotificationPageResponse>;
export const NotificationPageResponse = z.object({ items: z.array(NotificationResponse), next_cursor: z.string().nullable() }).catchall(z.unknown());
...
export const PasswordResetConfirmRequest = z.object({ new_password: z.string().min(8).max(128), token: z.string().min(1) }).catchall(z.unknown());

export type PasswordResetRequest = z.infer<typeof PasswordResetRequest>;
export const PasswordResetRequest = z.object({ email: z.email() }).catchall(z.unknown());

export type PasswordResetTokenCheck = z.infer<typeof PasswordResetTokenCheck>;
export const PasswordResetTokenCheck = z.object({ token: z.string().min(1) }).catchall(z.unknown());
...
export const RegisterRequest = z.object({ display_name: z.string(), email: z.email(), password: z.string().min(8).max(128) }).catchall(z.unknown());

export type RegistrationResponse = z.infer<typeof RegistrationResponse>;
export const RegistrationResponse = z.object({ email: z.string() }).catchall(z.unknown());

export type ResendVerificationRequest = z.infer<typeof ResendVerificationRequest>;
export const ResendVerificationRequest = z.object({ email: z.email() }).catchall(z.unknown());

export type ShareResponse = z.infer<typeof ShareResponse>;
export const ShareResponse = z.object({ created_at: z.iso.datetime(), granted_by: z.uuid(), id: z.uuid(), principal_id: z.uuid(), principal_name: z.string(), principal_type: PrincipalType, resource_id: z.uuid(), resource_type: z.string(), role: ShareRole }).catchall(z.unknown());

export type ResourceAccessResponse = z.infer<typeof ResourceAccessResponse>;
export const ResourceAccessResponse = z.object({ direct_shares: z.array(ShareResponse), inherited_dashboards: z.array(InheritedDashboardAccessResponse).default([]) }).catchall(z.unknown());
...
export const TrashedDashboardSummary = z.object({ deleted_at: z.iso.datetime(), id: z.uuid(), name: z.string(), purge_at: z.iso.datetime() }).catchall(z.unknown());

export type TrashedEventCursor = z.infer<typeof TrashedEventCursor>;
export const TrashedEventCursor = z.object({ deleted_at: z.iso.datetime(), id: z.uuid() }).catchall(z.unknown());

export type TrashedEventSummary = z.infer<typeof TrashedEventSummary>;
export const TrashedEventSummary = z.object({ dashboard_id: z.uuid(), deleted_at: z.iso.datetime(), id: z.uuid(), purge_at: z.iso.datetime(), recurring: z.boolean(), starts_at: z.iso.datetime(), title: z.string() }).catchall(z.unknown());

export type TrashedEventPage = z.infer<typeof TrashedEventPage>;
export const TrashedEventPage = z.object({ items: z.array(TrashedEventSummary), next_cursor: TrashedEventCursor.nullable().optional() }).catchall(z.unknown());

export type TrashedListSummary = z.infer<typeof TrashedListSummary>;
export const TrashedListSummary = z.object({ dashboard_id: z.uuid(), deleted_at: z.iso.datetime(), id: z.uuid(), list_type: ListType, name: z.string(), purge_at: z.iso.datetime() }).catchall(z.unknown());

export type UnreadCountResponse = z.infer<typeof UnreadCountResponse>;
export const UnreadCountResponse = z.object({ count: z.number().int() }).catchall(z.unknown());

export type UserPreferences = z.infer<typeof UserPreferences>;
export const UserPreferences = z.object({ favorite_dashboard_ids: z.array(z.string()), home_dashboard_id: z.string().nullable() }).partial().catchall(z.unknown());

export type UserResponse = z.infer<typeof UserResponse>;
export const UserResponse = z.object({ display_name: z.string(), email: z.string(), email_verified_at: z.iso.datetime().nullable().optional(), id: z.uuid(), preferences: UserPreferences.optional() }).catchall(z.unknown());

export type VerifyEmailRequest = z.infer<typeof VerifyEmailRequest>;
export const VerifyEmailRequest = z.object({ token: z.string().min(1) }).catchall(z.unknown());

export type WidgetConfigUpdate = z.infer<typeof WidgetConfigUpdate>;
export const WidgetConfigUpdate = z.object({ config: z.record(z.string(), z.unknown()) }).catchall(z.unknown());
