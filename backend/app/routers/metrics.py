...
# Set cardinalities, so unlike every other gauge here they do not sum across replicas — one person
# on two devices can land on two of them. Queries take max(): exact at one replica, a floor beyond.
