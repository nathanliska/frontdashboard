...
| [ADR-004](ADR-004-sse-over-websocket.md) | SSE (not WebSocket), one multiplexed connection per open tab | 2026-09-06 |
...
| [ADR-009](ADR-009-canonical-layout-mobile-projection.md) | Persisted layout is canonical on a bounded 24 x 24 grid, the stacked view is a derived projection | 2026-09-06 |
...
| [ADR-020](ADR-020-resource-quotas.md) | Per-creator resource quotas, counted over non-purged rows | 2026-09-09 |
